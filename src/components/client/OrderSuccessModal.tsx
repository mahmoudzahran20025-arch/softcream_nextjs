...
${order.branch ? `🏢 *الفرع:* ${order.branch}` : ''}
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-gray-800 dark:text-gray-100">
                    {order.deliveryMethod === 'pickup' ? '🏪 استلام من الفرع' : '🚚 توصيل للعنوان'}
                  </span>
                </div>
                ...
                {(order.branchName || order.branch) && (
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-blue-100 dark:border-gray-600">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">
                      {order.deliveryMethod === 'pickup' ? 'الفرع المحدد للاستلام' : 'الفرع المسؤول عن التوصيل'}
                    </p>
