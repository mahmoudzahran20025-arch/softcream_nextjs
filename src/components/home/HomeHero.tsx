...
// useHydrated hook available for future hydration checks
// import { useHydrated } from '@/hooks/useHydrated'

export default function HomeHero() {
    // Hydration check not currently needed for this component
        ...
        <section className="relative h-[85vh] w-full overflow-hidden bg-white flex flex-col items-center justify-center">
            ...
            <div className="relative z-10 container px-4 flex flex-col items-center text-center">
                ...
                <motion.button
                    ...
                    className="group relative px-8 py-4 bg-slate-900 text-white rounded-full text-lg font-bold shadow-xl hover:shadow-2xl hover:shadow-pink-500/20 transition-all overflow-hidden"
                >
