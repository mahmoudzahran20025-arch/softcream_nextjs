...
/**
 * FilterBar Component - Enhanced Version for Next.js
 * 
 * ✅ Features:
 * - Smooth animations
 * - Better visual hierarchy
 * - Primary Pink (#FF6B9D) as main color
 * - Micro-interactions
 * - Mobile-responsive
          ...
          <div className="relative flex-1">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute left-3 top-1/2 -translate-y-1/2 p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-all"
              >
                <X className="w-4 h-4" />
              </button>
            )}
          ...
          <button
            ...
            className={`
              ...
              ${showAdvanced 
                ...
                : 'bg-white text-gray-700 border-gray-200 hover:border-[#FF6B9D] hover:bg-[#FF6B9D]/5'
              }
            `}
          >
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${isActive
                          ...
                          : 'bg-white border-2 border-gray-200 text-gray-700 hover:border-[#FF6B9D] hover:bg-[#FF6B9D]/5'
                        }
                      `}
                      style={{
            ...
            {activeFilterCount > 0 && (
              <button
                ...
                className="
                  ...
                  bg-red-50 hover:bg-gradient-to-r hover:from-red-500 hover:to-pink-600 
                  rounded-xl 
                  transition-all duration-300
                  border-2 border-red-200 hover:border-transparent
                "
              >
